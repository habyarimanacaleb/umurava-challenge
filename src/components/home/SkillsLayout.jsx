...
const SkillsLayout = () => {
  return (
    ...
    <div className="bg-gray-50 py-16 px-6">
      ...
      {/* Card Section */}
      <div className="bg-white shadow-lg rounded-lg flex flex-col lg:flex-row items-center mt-16 max-w-6xl mx-auto p-6 lg:p-12">
        {/* Text Content */}
        <div className="lg:w-1/2 text-center lg:text-left">
          <div className="w-10 h-10 bg-gray-950 rounded-full flex items-center justify-center text-xl font-semibold mb-4">
           <span className='text-green-600'>s</span><span className='text-gray-300'>f.</span>
          </div>
          ...
          >
            Learn more{" "}
  <span className="inline-flex items-center justify-center w-6 h-6 ml-2 bg-blue-500 rounded-full
   text-gray-100">&#8594;</span>
          </a>
        </div>
